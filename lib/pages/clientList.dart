...
class _ClientListPageState extends State<ClientListPage> {
    ...
    try {
      ...
      if (allSessions.isEmpty) {
        ...
        for (int i = 0; i < allSessions.length; i++) {
          ...
          print(
            '     Співпадає: ${session.masterId == widget.masterId ? "✅ ТАК" : "❌ НІ"}',
          );
          print('     ---');
        }
      }
  ...
  Future<void> _loadSessions() async {
    try {
      ...
      print(
        'Завантажуємо сесії для майстра ${widget.masterId} на дату $dateString',
      );
  ...
  Future<void> _openWhatsApp(String? phone) async {
    ...
    print(
      '📞 Форматування номера: "$phone" → "$cleanPhone" → "$formattedPhone"',
    );
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              ...
              content: Text(
                language.getText(
                  'WhatsApp не встановлено або він недоступний',
                  'WhatsApp не установлен или недоступен',
                ),
              ),
              backgroundColor: Theme.of(context).colorScheme.error,
            ),
  ...
  Future<void> _makePhoneCall(String? phone) async {
    ...
    print(
      '📞 Форматування номера для дзвінка: "$phone" → "$cleanPhone" → "$formattedPhone"',
    );
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Text(
              language.getText(
                'Помилка здійснення дзвінка',
                'Ошибка совершения звонка',
              ),
            ),
            backgroundColor: Theme.of(context).colorScheme.error,
          ),
                              ...
                              children: [
                                ...
                                Consumer<LanguageProvider>(
                                  builder: (context, language, child) {
                                    return Text(
                                      language.getText(
                                        'Додайте новий запис кнопкою +',
                                        'Добавьте новую запись кнопкой +',
                                      ),
                                      style: TextStyle(
                                        fontSize: 14,
                                        color: Theme.of(
                                  ...
                                  children: [
                                    ...
                                    if (session.phone != null &&
                                      ...
                                      Positioned(
                                        ...
                                        child: IconButton(
                                          onPressed: () =>
                                              _openWhatsApp(session.phone),
                                          icon: FaIcon(
                                            FontAwesomeIcons.whatsapp,
                                            color: Color(
                                              0xFF25D366,
                                            ), // Офіційний колір WhatsApp
                                            size: 40,
                                          ),
                                          tooltip:
                                              Provider.of<LanguageProvider>(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () =>
                            _updateSessionStatus(session, "в очікуванні"),
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () =>
                            _updateSessionStatus(session, "успішно"),
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () =>
                            _updateSessionStatus(session, "пропущено"),
                      ),
                    ),
  ...
  Future<void> _updateSessionStatus(Session session, String newStatus) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            '${language.getText('Помилка оновлення статусу', 'Ошибка обновления статуса')}: $e',
          ),
