                  ...
                  Expanded(
                    child: Consumer<LanguageProvider>(
                      builder: (context, language, child) {
                        return Text(
                          language.getText('Клієнтка успішно додана!', 'Клиентка успешно добавлена!'),
                          style: TextStyle(
                            fontSize: 16,
                ...
                children: [
                  ...
                  Expanded(
                    child: Consumer<LanguageProvider>(
                      builder: (context, language, child) {
                        return Text(
                          language.getText('Помилка збереження: $e', 'Ошибка сохранения: $e'),
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.w500,
                          ),
                          ...
                          child: Column(
                            ...
                            children: [
                              Consumer<LanguageProvider>(
                                builder: (context, language, child) {
                                  return Text(
                                    language.getText('Додавання нової клієнтки', 'Добавление новой клиентки'),
                                    style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold,
                              ...
                              Consumer<LanguageProvider>(
                                builder: (context, language, child) {
                                  return Text(
                                    language.getText('Заповніть інформацію про клієнтку', 'Заполните информацию о клиентке'),
                                    style: TextStyle(
                                      fontSize: 14,
